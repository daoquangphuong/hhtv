"undefined" == typeof jwplayer && (jwplayer = function(f) {
    ...
    b.getAbsolutePath = function(g, a) {
        ...
        if (b.exists(g)) {
            ...
            var j = a.substring(c.length, a.indexOf("/", c.length + 1)),
                d;
            0 === g.indexOf("/") ? d = g.split("/") : (d = a.split("?")[0], d = d.substring(c.length + j.length + 1, d.lastIndexOf("/")), d = d.split("/").concat(g.split("/")));
            for (var h = [], e = 0; e < d.length; e++) d[e] && (b.exists(d[e]) && "." != d[e]) && (".." == d[e] ? h.pop() : h.push(d[e]));
            return c + j + "/" + h.join("/")
        }
    };
    b.extend = function() {
        ...
        if (1 < a.length) {
            for (var c = 1; c < a.length; c++) b.foreach(a[c], function(c, d) {
                try {
                    b.exists(d) && (a[0][c] = d)
                } catch (j) {}
            });
    ...
    b.saveCookie = function(a, b) {
        l.cookie = "jwplayer." + a + "\x3d" + b + "; path\x3d/"
    };
    ...
    b.deepReplaceKeyName = function(a, d, c) {
        switch (f.utils.typeOf(a)) {
            case "array":
                for (var j = 0; j < a.length; j++) a[j] = f.utils.deepReplaceKeyName(a[j], d, c);
                break;
            case "object":
                b.foreach(a, function(b, h) {
                    ...
                    for (var e = b, l = 0; l < j.length; l++) e = e.replace(RegExp(d[l],
                        "g"), c[l]);
    ...
    b.repo = function() {
        var a = "http://www.hayhaytv.vn/jwplayer/" + f.version.split(/\W/).splice(0, 2).join("/") + "/";
        try {
    ...
    f.scriptloader = function(e) {
        ...
        this.load = function() {
            ...
            if (g && (g.getStatus() == a.NEW || g.getStatus() == a.LOADING)) g.addEventListener(d.ERROR, j), g.addEventListener(d.COMPLETE, b);
            else if (f.scriptloader.loaders[e] = this, c == a.NEW) {
                c = a.LOADING;
    ...
    a.encrypt = function(j, b) {
        ...
        for (var d = a.strToLongs(e.encode(b).slice(0, 16)), g = c.length, f = c[g - 1], m = c[0], n, k = Math.floor(6 + 52 / g), h = 0; 0 < k--;) {
            h += 2654435769;
            n = h >>> 2 & 3;
            for (var r = 0; r < g; r++) m = c[(r + 1) % g], f = (f >>> 5 ^ m << 2) + (m >>> 3 ^ f << 4) ^ (h ^ m) + (d[r & 3 ^ n] ^ f), f = c[r] += f
        }
        c = a.longsToStr(c);
        return l.encode(c)
    };
    a.decrypt = function(j, b) {
        if (0 == j.length) return "";
        for (var c = a.strToLongs(l.decode(j)),
                 d = a.strToLongs(e.encode(b).slice(0, 16)), g = c.length, f = c[g - 1], m = c[0], n, k = 2654435769 * Math.floor(6 + 52 / g); 0 != k;) {
            n = k >>> 2 & 3;
            for (var h = g - 1; 0 <= h; h--) f = c[0 < h ? h - 1 : g - 1], f = (f >>> 5 ^ m << 2) + (m >>> 3 ^ f << 4) ^ (k ^ m) + (d[h & 3 ^ n] ^ f), m = c[h] -= f;
            k -= 2654435769
        }
        c = a.longsToStr(c);
        c = c.replace(/\0+$/, "");
    ...
    a.strToLongs = function(a) {
        for (var b = Array(Math.ceil(a.length / 4)), c = 0; c < b.length; c++) b[c] = a.charCodeAt(4 * c) + (a.charCodeAt(4 * c + 1) << 8) + (a.charCodeAt(4 * c + 2) << 16) + (a.charCodeAt(4 * c + 3) << 24);
        return b
    };
    a.longsToStr = function(a) {
        for (var b = Array(a.length), c = 0; c < a.length; c++) b[c] = String.fromCharCode(a[c] & 255, a[c] >>> 8 & 255, a[c] >>> 16 & 255, a[c] >>> 24 & 255);
        return b.join("")
    };
    var l = {
        ...
        encode: function(a, b) {
            ...
            k = h.length % 3;
            if (0 < k) for (; 3 > k++;) n += "\x3d", h += "\x00";
            for (k = 0; k < h.length; k += 3) c = h.charCodeAt(k), d = h.charCodeAt(k + 1), g = h.charCodeAt(k + 2), f = c << 16 | d << 8 | g, c = f >> 18 & 63, d = f >> 12 & 63, g = f >> 6 & 63, f &= 63, m[k / 3] = r.charAt(c) + r.charAt(d) + r.charAt(g) + r.charAt(f);
            m = m.join("");
        ...
        decode: function(a, b) {
            ...
            var c, d, g, f, m, n = [],
                k, h = l.code;
            k = b ? e.decode(a) : a;
            for (var r = 0; r < k.length; r += 4) c = h.indexOf(k.charAt(r)), d = h.indexOf(k.charAt(r + 1)), f = h.indexOf(k.charAt(r + 2)), m = h.indexOf(k.charAt(r + 3)), g = c << 18 | d << 12 | f << 6 | m, c = g >>> 16 & 255, d = g >>> 8 & 255, g &= 255, n[r / 4] = String.fromCharCode(c, d, g), 64 == m && (n[r / 4] = String.fromCharCode(c, d)), 64 == f && (n[r / 4] = String.fromCharCode(c));
            f = n.join("");
    ...
    f.eventdispatcher = function(f, e) {
        ...
        this.addEventListener = function(b, d, g) {
            try {
                a.exists(j[b]) || (j[b] = []), "string" == a.typeOf(d) && (d = (new Function("return " + d))()), j[b].push({
                    listener: d,
                    count: g
                })
            } catch (e) {
        ...
        this.removeEventListener = function(b, d) {
            if (j[b]) {
                try {
                    for (var g = 0; g < j[b].length; g++) if (j[b][g].listener.toString() == d.toString()) {
                        j[b].splice(g, 1);
                        break
                    }
                } catch (e) {
        ...
        this.addGlobalListener = function(c, d) {
            try {
                "string" == a.typeOf(c) && (c = (new Function("return " + c))()), b.push({
                    listener: c,
                    count: d
                })
            } catch (g) {
        ...
        this.removeGlobalListener = function(c) {
            if (c) {
                try {
                    for (var d = 0; d < b.length; d++) if (b[d].listener.toString() == c.toString()) {
                        b.splice(d, 1);
                        break
                    }
                } catch (g) {
        ...
        this.sendEvent = function(c, d) {
            ...
            e && a.log(c, d);
            if ("undefined" != a.typeOf(j[c])) for (var g = 0; g < j[c].length; g++) {
                try {
                    j[c][g].listener(d)
                } catch (q) {
    ...
    f.plugin = function(e) {
        ...
        var d = a.loaderstatus.NEW,
            g, q, m, n, k = new l.eventdispatcher;
        a.extend(this, k);
        this.load = function() {
            if (d == a.loaderstatus.NEW) if (0 < e.lastIndexOf(".swf")) g = e, d = a.loaderstatus.COMPLETE, k.sendEvent(l.COMPLETE);
            else if (a.getPluginPathType(e) == a.pluginPathType.CDN) d = a.loaderstatus.COMPLETE, k.sendEvent(l.COMPLETE);
            else {
        ...
        this.getFlashPath = function() {
            if (g) switch (a.getPluginPathType(g)) {
                case a.pluginPathType.ABSOLUTE:
                    return g;
                case a.pluginPathType.RELATIVE:
        ...
        this.getPluginmode = function() {
            if ("undefined" != typeof g && "undefined" != typeof q) return f.pluginmodes.HYBRID;
            if ("undefined" != typeof g) return f.pluginmodes.FLASH;
            if ("undefined" != typeof q) return f.pluginmodes.JAVASCRIPT
        };
    ...
    f.plugins.pluginloader = function(j, b) {
        function c() {
            m ? h.sendEvent(l.ERROR, {
                message: n
            }) : q || (q = !0, g = a.loaderstatus.COMPLETE, h.sendEvent(l.COMPLETE))
        }
        ...
        function d() {
            ...
            if (!q && !m) {
                ...
                a.foreach(k, function(g) {
                    ...
                    var h = e.getTarget(),
                        e = e.getStatus();
                    if (e == a.loaderstatus.LOADING || e == a.loaderstatus.NEW) b++;
                    else if (g && (!h || parseFloat(h) > parseFloat(f.version))) m = !0, n = "Incompatible player version", c()
                });
                0 == b && c()
            }
        }
    ...
    f.playlist = function(a) {
        var l = [];
        if ("array" == f.utils.typeOf(a)) for (var e = 0; e < a.length; e++) l.push(new f.playlist.item(a[e]));
        else l.push(new f.playlist.item(a));
        return l
    }
}(jwplayer), function(f) {
    var a = f.item = function(l) {
        var e = jwplayer.utils,
            j = e.extend({}, a.defaults, l);
        ...
        for (b = 0; b < j.tracks.length; b++) j.tracks[b] = new f.track(j.tracks[b]);
        return j
    };
    a.defaults = {
        description: "",
        ...
        j = f.embed = function(b) {
            ...
            function q(b, d) {
                if (m.fallback) {
                    ...
                    c.innerHTML = d.replace(":", ":\x3cbr\x3e");
                    b.innerHTML = "";
                    b.appendChild(c)
                }
            }
            var m = new j.config(b.config),
                n, k, h, r = m.width,
                p = m.height,
                t = "Error loading player: ",
                s = f.plugins.loadPlugins(b.id, m.plugins);
            ...
            s.addEventListener(l.COMPLETE, function() {
                if ("array" == a.typeOf(m.playlist) && 2 > m.playlist.length && (0 == m.playlist.length || !m.playlist[0].sources || 0 == m.playlist[0].sources.length)) g();
                else if (s.getStatus() == a.loaderstatus.COMPLETE) {
                    for (var e = 0; e < m.modes.length; e++) if (m.modes[e].type && j[m.modes[e].type]) {
                        var f = a.extend({}, m),
                            r = new j[m.modes[e].type](n, m.modes[e], f, s, b);
                        if (r.supportsConfig()) return r.addEventListener(l.ERROR, d), r.embed(), c(b, f.events), b
                    }
                    m.fallback ? (a.log("No suitable players found and fallback enabled"), new j.download(n, m, g)) : (a.log("No suitable players found and fallback disabled"), n.parentNode.replaceChild(h,
                        n))
                }
            });
    ...
    function a(a) {
        if (a.playlist) for (var c = 0; c < a.playlist.length; c++) a.playlist[c] = new j(a.playlist[c]);
        else {
            var d = {};
    ...
    (f.embed.config = function(b) {
        ...
        a(b);
        d = b.aspectratio;
        if ("string" != typeof d || !e.exists(d)) c = 0;
        else {
            var g = d.indexOf(":"); - 1 == g ? c = 0 : (c = parseFloat(d.substr(0, g)), d = parseFloat(d.substr(g + 1)), c = 0 >= c || 0 >= d ? 0 : 100 * (d / c) + "%")
    ...
    f.embed.download = function(e, f, b) {
        function c(b, d) {
            for (var c = l.querySelectorAll(b), g = 0; g < c.length; g++) a.foreach(d, function(a, b) {
                c[g].style[a] = b
            })
        }
        function d(a, b, d) {
        ...
        var g = a.extend({}, f),
            q = g.width ? g.width : 480,
            m = g.height ? g.height : 320,
            n;
        f = f.logo ? f.logo : {
            prefix: a.repo(),
            file: "logo.png",
        ...
        if (g && g.length) {
            ...
            for (g = 0; g < n.length; g++) {
                var s = n[g],
                    u = s.type ? s.type : a.extensionmap.extType(a.extension(s.file));
                s.file && a.foreach(t, function(b) {
                    u == t[b] ? (k = s.file, h = p.image) : a.isYouTube(s.file) && (r = s.file)
                })
            }
            k ? (n = k, b = h, e && (g = d("a", "display", e), d("div", "icon", g), d("div", "logo", g), n && g.setAttribute("href", a.getAbsolutePath(n))), g = "#" + e.id + " .jwdownload", e.style.width = "", e.style.height = "", c(g + "display", {
    ...
    (f.embed.flash = function(j, b, c, d, g) {
        ...
        this.embed = function() {
            c.id = g.id;
            if (10 > h) return k.sendEvent(l.ERROR, {
                message: "Flash version must be 10.0 or greater"
            }), !1;
            var f, p, t = g.config.listbar,
                s = a.extend({}, c);
            if (j.id + "_wrapper" == j.parentNode.id) f = document.getElementById(j.id + "_wrapper");
            else {
            ...
            for (t = 0; t < p.length; t++) delete s[p[t]];
            p = a.getCookies();
            ...
            s.base = p + "/";
            e[j.id] = s;
            a.isIE() ? (p = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width\x3d"100%" height\x3d"100%"id\x3d"' + j.id + '" name\x3d"' + j.id + '" tabindex\x3d0""\x3e', p += '\x3cparam name\x3d"movie" value\x3d"' + b.src + '"\x3e', p += '\x3cparam name\x3d"allowfullscreen" value\x3d"true"\x3e\x3cparam name\x3d"allowscriptaccess" value\x3d"always"\x3e', p += '\x3cparam name\x3d"seamlesstabbing" value\x3d"true"\x3e', p += '\x3cparam name\x3d"wmode" value\x3d"' + f + '"\x3e', p += '\x3cparam name\x3d"bgcolor" value\x3d"#000000"\x3e', p += "\x3c/object\x3e", j.outerHTML = p, f = document.getElementById(j.id)) : (p = document.createElement("object"), p.setAttribute("type", "application/x-shockwave-flash"), p.setAttribute("data", b.src), p.setAttribute("width",
                "100%"), p.setAttribute("height", "100%"), p.setAttribute("bgcolor", "#000000"), p.setAttribute("id", j.id), p.setAttribute("name", j.id), p.setAttribute("tabindex", 0), q(p, "allowfullscreen", "true"), q(p, "allowscriptaccess", "always"), q(p, "seamlesstabbing", "true"), q(p, "wmode", f), j.parentNode.replaceChild(p, j), f = p);
                ...
                try {
                    ...
                    for (var d = 0; d < b.length; d++) {
                        ...
                        if (g = b[d].file) {
                            var e = b[d].file,
                                f = b[d].type;
                            if (a.isYouTube(e) || a.isRtmp(e, f) || "hls" == f) g = !0;
                            else {
    ...
    f.embed.html5 = function(j, b, c, d, g) {
        ...
        n.embed = function() {
            if (f.html5) {
                ...
                g.setPlayer(h,
                    "html5")
            } else h = new a.scriptloader(b.src), h.addEventListener(e.ERROR, m), h.addEventListener(e.COMPLETE, n.embed), h.load()
        };
        n.supportsConfig = function() {
            if (f.vid.canPlayType) try {
                ...
                for (var b = c.playlist[0].sources, d = 0; d < b.length; d++) {
                    ...
                    var e = b[d].file,
                        j = b[d].type;
                    if (null !== navigator.userAgent.match(/BlackBerry/i) || a.isAndroid() && ("m3u" == a.extension(e) || "m3u8" == a.extension(e)) || a.isRtmp(e, j)) g = !1;
                    else {
                        var k = l[j ? j : a.extension(e)],
                            m;
    ...
    var a = f.embed,
        l = f.utils,
        e = l.extend(function(e) {
            var b = l.repo(),
                c = l.extend({}, f.defaults),
                d = l.extend({}, c, e.config),
                g = e.config,
                q = d.plugins,
                m = d.analytics,
                n = b + "jwpsrv.js",
            ...
            delete g.analytics;
            if ("free" == p || !m || !1 !== m.enabled) q[n] = m ? m : {};
            delete q.sharing;
            delete q.related;
            if ("premium" == p || "ads" == p) d.sharing && (d.sharing.client && d.sharing.client.match(".js$|.swf$") && (k = d.sharing.client), q[k] = d.sharing), d.related && (d.related.client && d.related.client.match(".js$|.swf$") && (h = d.related.client),
                q[h] = d.related), d.ga && (d.ga.client && d.ga.client.match(".js$|.swf$") && (r = d.ga.client), q[r] = d.ga), d.skin && (g.skin = d.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i, l.repo() + "skins/$1.xml"));
            g.plugins = q;
            return new a(e)
        }, a);
    f.embed = e
        ...
        c = f.api = function(a) {
            ...
            function q(a, b) {
                p[a] || (p[a] = [], n(e.JWPLAYER_PLAYER_STATE, function(b) {
                    ...
                    if (d == a) {
                        var c = p[d];
                        if (c) for (var g = 0; g < c.length; g++) "function" == typeof c[g] && c[g].call(this, {
                            oldstate: b,
                            newstate: d
                        })
                    }
            ...
            h.resize = function(a, d) {
                if ("flash" != h.renderingMode) {
                    ...
                    var c = b.getElementById(h.id + "_wrapper"),
                        g = b.getElementById(h.id + "_aspect");
            ...
            h.detachMedia = function() {
                if ("html5" == h.renderingMode) return k("jwDetachMedia")
            };
            h.attachMedia = function(a) {
                if ("html5" == h.renderingMode) return k("jwAttachMedia", a)
            };
            h.dispatchEvent = function(a, b) {
                if (r[a]) for (var d = l.translateEventResponse(a, b), c = 0; c < r[a].length; c++) if ("function" == typeof r[a][c]) try {
            ...
            h.playerReady = function(a) {
                ...
                for (h.dispatchEvent(e.API_READY); 0 < u.length;) k.apply(this, u.shift())
            };
    ...
    c.destroyPlayer = function(d) {
        for (var c = -1, e, f = 0; f < a.length; f++) a[f].id == d && (c = f, e = a[f]);
        0 <= c && (d = e.id, f = b.getElementById(d + ("flash" == e.renderingMode ? "_wrapper" : "")), l.clearCss && l.clearCss("#" + d), f && ("html5" == e.renderingMode && e.destroyPlayer(),
            e = b.createElement("div"), e.id = d, f.parentNode.replaceChild(e, f)), a.splice(c, 1));
        return null
    };
    ...
    f.api.instream = function(f, b, c, d) {
        ...
        function q(b, c) {
            h[b] || (h[b] = [], g(a.JWPLAYER_PLAYER_STATE,
        ...
        this.dispatchEvent = function(a, b) {
            if (k[a]) for (var c = l.translateEventResponse(a, b[1]), d = 0; d < k[a].length; d++) "function" == typeof k[a][d] && k[a][d].call(this, c)
        };
